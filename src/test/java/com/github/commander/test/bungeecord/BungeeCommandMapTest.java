...
import com.github.commander.test.bungeecord.mock.MockBungeeeCommandMap;
...
public class BungeeCommandMapTest {
	...
	public void invalidGetMapIfExists() {
		...
		assertTrue(map.getMapIfExists(Map.class) == null);
	}
	...
	public void invalidGetCommandMap() {
		...
		try {
			...
			Object BungeeCommandMap = getCommandMap.invoke(map, SimpleCommandMap.class);
